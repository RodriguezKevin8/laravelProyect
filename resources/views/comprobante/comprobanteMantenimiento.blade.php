...
<html>
<head>
    <title>Comprobante de Mantenimiento</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Comprobante de Mantenimiento</h1>
        <div class="divider"></div>
        <p><span class="bold">Descripción:</span> {{ $datosComprobante['descripcion'] }}</p>
        <p><span class="bold">Precio de mantenimiento:</span> ${{ number_format($datosComprobante['total'], 2) }}</p>
        <p><span class="bold">Mano de obra:</span> ${{ number_format($datosComprobante['mano_de_obra'], 2) }}</p>
        ...
        <p><span class="bold">Precio final:</span> ${{ number_format($datosComprobante['total_mantenimiento'], 2) }}</p>
        <div class="divider"></div>
        <div class="thanks">
            <p>Vuelva pronto por su mantenimiento te esperamos el: {{ $datosComprobante['proximo_mantenimiento'] }}. En nombre de <strong>Concesionaria Star</strong>, le agradecemos su confianza.</p>
